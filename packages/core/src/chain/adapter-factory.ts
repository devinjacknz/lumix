...
export class ChainAdapterFactory {
  ...
  private initializeAdapters(): void {
    console.debug('Initializing chain adapters...');
    console.debug('Logger state:', { logger, isLoggerInitialized: !!logger });
    ...
    if (logger && typeof logger.info === 'function') {
      ...
      console.warn('Logger not properly initialized in ChainAdapterFactory');
    }
  }
