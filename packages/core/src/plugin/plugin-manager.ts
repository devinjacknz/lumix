...
export class PluginManager {
  ...
  public async validatePermissions(plugin: Plugin): Promise<boolean> {
    try {
      ...
      logger.error('Plugin', `Permission validation failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
      return false;
    }
  }
}